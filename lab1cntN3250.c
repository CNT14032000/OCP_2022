            ...
            if(strcmp(entity->d_name, ".") != 0 && strcmp(entity->d_name, "..") != 0){
                ...
                if(entity->d_type == DT_REG) {
                    ...
                    if(plugins_call){
                        ...
                        if ( ret_true == plugins_call && is_or == 0 && is_not == 0) fprintf(stdout, "files found  :%s\n", path);
                        //short_opt O;
                        else if (ret_true > 0 && is_or == 1 && is_not == 0) fprintf(stdout, "files found  :%s\n", path);
                        //short_opt NA;
                        else if (ret_true < plugins_call && is_or ==0 && is_not ==1) fprintf(stdout, "files found :%s\n", path);
                        //short_opt NO;
                        else if (ret_true == 0 && is_or == 1 && is_not == 1) fprintf(stdout, "files found :%s\n", path);
